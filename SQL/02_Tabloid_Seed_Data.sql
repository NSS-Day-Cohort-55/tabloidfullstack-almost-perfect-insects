...
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (1, 'Bory', 'Bory', 'Blark', 'Bory@Blark.com', '2020-04-23', 'https://robohash.org/numquamutut.png?size=150x150&set=set1', 1, 'sdjJnhd0cOQ7k8I0FM361EdjVn23');
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (2, 'KidVishus', 'Vishal', 'Trivedi', 'Vishy@Fishy.com', '2020-04-20', 'https://robohash.org/nisiautemet.png?size=150x150&set=set1', 2, 'hcg7ZYMVx3aSuvkE4PvlDBuXmV83');
